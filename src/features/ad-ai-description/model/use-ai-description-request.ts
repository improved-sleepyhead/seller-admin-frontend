...
interface DescriptionRequestState {
  cancel: () => void
  canStart: boolean
  errorMessage: string | null
  isPending: boolean
  response: AiDescriptionResponse | null
...
function useAiDescriptionRequest({
  disabled,
  form
}: ActionOptions): DescriptionRequestState {
...
export { useAiDescriptionRequest }
